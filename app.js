...
// Função principal para gerar os elementos da seção main
function criarConteudoMain() {
...
document.addEventListener("DOMContentLoaded", criarConteudoMain);